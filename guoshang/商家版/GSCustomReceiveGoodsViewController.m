//
//  GSCustomReceiveGoodsViewController.m
//  guoshang
//
...
@interface GSCustomReceiveGoodsViewController ()
...
@implementation GSCustomReceiveGoodsViewController
...
-(void)createCustomData{
    ...
    NSString * userId = [NSString stringWithFormat:@"shop_id=%@,page=%d,goods_type=%@,order_sn=%@,type=un_receipt", GS_Business_Shop_id,self.page,self.goods_type,self.order_number];
...
-(void)createUserData{
    ...
    NSString * userId = [NSString stringWithFormat:@"shop_id=%@,page=%d,order_state=4", self.shop_id,self.page];
    encryptString = [userId encryptStringWithKey:KEY];
    __weak typeof(self) weakSelf = self;
...
//    }else{
//        GSMyOrderModel *model  = self.dataArray[section];
