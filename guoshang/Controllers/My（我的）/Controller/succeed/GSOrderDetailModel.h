...
@interface GSOrderDetailModel : NSObject
...
@property (strong, nonatomic) GSOrderTotalModel *total;
...
@property (copy, nonatomic) NSString *ecs_order_info_id;
...
@property (copy, nonatomic) NSString *show_refund;
