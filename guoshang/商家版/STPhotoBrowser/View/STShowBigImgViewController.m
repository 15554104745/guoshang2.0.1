...
@interface STShowBigImgViewController () <UIScrollViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate>
{
...
@implementation STShowBigImgViewController
...
- (void)initNavBtns
{
    ...
    UIImage *normalImg = [UIImage imageNamed:@"btn_circle"]?:[UIImage imageNamed:@"btn_circle"];
    UIImage *selImg = [UIImage imageNamed:@"btn_selected"]?:[UIImage imageNamed:@"btn_selected"];
...
- (void)initCollectionView
{
    ...
    [_collectionView registerClass:[STBigImageCell class] forCellWithReuseIdentifier:@"STBigImageCell"];
...
- (void)initBottomView
{
    ...
    [_btnOriginalPhoto setTitleColor:kNavigationBarBackColor forState: UIControlStateNormal];
    [_btnOriginalPhoto setTitleColor:kNavigationBarBackColor forState: UIControlStateSelected];
    UIImage *normalImg = [UIImage imageNamed:@"btn_original_circle"]?:[UIImage imageNamed:@"btn_original_circle"];
    UIImage *selImg = [UIImage imageNamed:@"btn_selected"]?:[UIImage imageNamed:@"btn_selected"];
    ...
    self.labPhotosBytes.textColor = kNavigationBarBackColor;
    ...
    [_btnDone setBackgroundColor:kNavigationBarBackColor];
...
{
    STBigImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"STBigImageCell" forIndexPath:indexPath];
