//
//  GSShopGoodsInfoViewController.m
//  guoshang
//
...
@interface GSShopGoodsInfoViewController ()<detailScrollViewDelegate,STTabBarDelegate,paramasDelegate,UICollectionViewDelegate> {
...
@implementation GSShopGoodsInfoViewController
#pragma mark - 初始化方法
+ (id)createGoodsDetailView {
    UIStoryboard *storlBoard = [UIStoryboard storyboardWithName:@"GoodsShow" bundle:nil];
    GoodsDetailViewController *goodsDetailVC = [storlBoard instantiateViewControllerWithIdentifier:@"GSShopGoodsInfoViewController"];
