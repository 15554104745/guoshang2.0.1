...
@interface GSMakeGroupViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong) UITableView *tableView;
@property (nonatomic,assign) int page;
@property (nonatomic,strong) NSMutableArray *dataArray;
@end

@implementation GSMakeGroupViewController
...
-(void)loadData{
    ...
    NSString * userId = [NSString stringWithFormat:@"user_id=%@,page=%d,status=inprogress",UserId,self.page++];
