...
#define kSTPhotoBrowserBundle [NSBundle bundleForClass:[self class]]

// 图片路径
#define kSTPhotoBrowserSrcName(file) [@"STPhotoBrowser.bundle" stringByAppendingPathComponent:file]
#define kSTPhotoBrowserFrameworkSrcName(file) [@"Frameworks/STPhotoBrowser.framework/STPhotoBrowser.bundle" stringByAppendingPathComponent:file]
