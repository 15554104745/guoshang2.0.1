...
@interface GSNewStartViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation GSNewStartViewController
{
...
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(NoClickCell:) name:@"timeGone" object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(buytype:) name:@"buyType" object:nil];
...
-(void)setDataArray:(NSMutableArray *)dataArray
{
    ...
    GSNewLimitModel *model = _dataArray[1];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([_buytype isEqualToString:@"5"] || [_buytype isEqualToString:@"6"]) {
        ...
        return cell;
        //已售完
    }else if([_buytype isEqualToString:@"0"] ||[_buytype isEqualToString:@"1"] ||[_buytype isEqualToString:@"2"] ||[_buytype isEqualToString:@"3"]||[_buytype isEqualToString:@"4"])
    {
        cell.goBuy.layer.borderColor = [UIColor grayColor].CGColor;
...
-(void)buytype:(NSNotification *)notification
{
