...
+ (UIView *)createHeaderView:(CGFloat)headerWH images:(NSArray *)images
{
    ...
    switch ([images count]) {
        case 1: {
            view = [JJHeaders getView1:headerWH images:imageArr];
            break;
        }
        case 2: {
            view = [JJHeaders getView2:headerWH images:imageArr];
            break;
        }
        case 3: {
            view = [JJHeaders getView3:headerWH images:imageArr];
            break;
        }
        case 4: {
            view = [JJHeaders getView4:headerWH images:imageArr];
            break;
        }
        case 5: {
            view = [JJHeaders getView5:headerWH images:imageArr];
            break;
        }
        default:
            break;
