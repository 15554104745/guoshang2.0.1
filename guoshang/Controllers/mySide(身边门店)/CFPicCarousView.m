...
- (void)doWithImgView{
    ...
    if (!self.isNetPic) {
        ...
        self.nextImgView.image = [UIImage imageNamed:[self.picModels[nextIndex]picName]];
         ...
         // 网络请求
        [self.preImgView setImageWithURL:[NSURL URLWithString:[self.picModels[preIndex] picUrl]] placeholderImage:[UIImage imageNamed:@""]];
        [self.currentImgView setImageWithURL:[NSURL URLWithString:[self.picModels[currentIndex] picUrl]] placeholderImage:[UIImage imageNamed:@""]];
        [self.nextImgView setImageWithURL:[NSURL URLWithString:[self.picModels[nextIndex] picUrl]] placeholderImage:[UIImage imageNamed:@""]];
    }
}
